...
app.get('/random/:id', (req, res) => {
    ...
    const ImageOfPlayers = ["https://https://admin.kickoff.rubyet.info/public/images/player/ronaldo.png", "https://https://admin.kickoff.rubyet.info/img/player/messi.png", "https://https://admin.kickoff.rubyet.info/img/player/neimar.png"];
