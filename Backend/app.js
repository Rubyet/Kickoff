...
app.get('/random/:id', (req, res) => {
    ...
    const ImageOfPlayers = ["https://fifafixture.rubyet.info/img/teams_logo/73.webp", "https://fifafixture.rubyet.info/img/teams_logo/72.webp", "https://fifafixture.rubyet.info/img/teams_logo/71.webp"];
